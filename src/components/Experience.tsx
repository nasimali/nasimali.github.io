    ...
    return (
        <section id="experience" className="py-16 md:py-24 scroll-mt-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary dark:text-primary-foreground">{experienceSectionContent.heading}</h2>
                    <p className="text-lg text-muted-foreground">
                        {experienceSectionContent.subheading}
                    </p>
                </motion.div>
                            ...
                            <Card className="hover:shadow-lg dark:hover:shadow-primary/20 transition-shadow duration-300 border-border hover:border-primary/30">
                                <CardHeader className="pb-3">
                                    ...
                                    <CardDescription className="text-sm sm:text-base">
                                        {exp.companyLink ? (
                                            <a href={exp.companyLink} target="_blank" rel="noopener noreferrer" className="hover:underline text-primary/90 dark:text-primary-foreground/90 font-medium">
                                                {exp.company}
                                            </a>
                                        ) : (
                                ...
                                <CardContent className="pt-0">
                                    ...
                                    {exp.skills && exp.skills.length > 0 && (
                                        <div className="mt-4">
                                            <h4 className="text-xs font-semibold text-foreground/70 mb-1.5">Key Skills:</h4>
                                            <div className="flex flex-wrap gap-1.5">
                                                {exp.skills.map(skill => <Badge key={skill} variant="outline" className="text-xs">{skill}</Badge>)}
                                            </div>
                                        </div>
                                    )}
                                </CardContent>
