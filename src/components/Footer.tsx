            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-xs text-muted-foreground flex items-center flex-wrap justify-center sm:justify-end">
                        ...
                        <DynamicIcon name="Heart" className="inline h-3.5 w-3.5 text-red-500" aria-label={footer.heartIconAlt} />
                        ...
                        <DynamicIcon name="Coffee" className="inline h-3.5 w-3.5 text-amber-600 dark:text-amber-400" aria-label={footer.coffeeIconAlt} />.
                    </p>
                </div>
            </div>
        </footer>
