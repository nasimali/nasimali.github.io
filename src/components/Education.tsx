      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary dark:text-primary-foreground">
            {educationSectionContent.heading}
          </h2>
          <p className="text-lg text-muted-foreground">{educationSectionContent.subheading}</p>
        </motion.div>
                  ...
                  <CardDescription className="text-sm sm:text-base">
                    {edu.institutionLink ? (
                      <a
                        ...
                        className="hover:underline text-purple-700 dark:text-purple-400 font-medium"
                      >
                        {edu.institution}
                      </a>
                    ) : (
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {edu.highlights.map((highlight) => (
                          <Badge
                            key={highlight}
                            variant="outline"
                            className="text-xs border-purple-500/50 text-purple-700 dark:text-purple-400"
                          >
                            {highlight}
                          </Badge>
                        ))}
