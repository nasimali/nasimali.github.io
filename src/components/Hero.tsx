        ...
        <section className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
            <div className="max-w-3xl z-10">
                ...
                >
                    ...
                    >
                        {hero.ctaViewWork} <DynamicIcon name="Briefcase" className="ml-2 h-5 w-5 group-hover:animate-pulse" />
                    </Button>
                    <Button
                        variant="outline"
                        size="lg"
                    ...
                    >
                        {hero.ctaGetInTouch} <DynamicIcon name="Mail" className="ml-2 h-5 w-5 group-hover:animate-bounce" />
                    </Button>
                </motion.div>
            </div>
            <motion.div
